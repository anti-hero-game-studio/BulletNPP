...
#include "BulletMovementRecord.generated.h"
...
struct FBulletMovementSubstep
{
	GENERATED_BODY()

	FBulletMovementSubstep() {}
	FBulletMovementSubstep(FName InMoveName, FVector InMoveDelta, bool InIsRelevant = true)
...
struct FBulletMovementRecord
{
	...
	UE_API void Append(FBulletMovementSubstep Substep);
	...
	const TArray<FBulletMovementSubstep>& GetSubsteps() const { return Substeps; }
...
private:
	...
	TArray<FBulletMovementSubstep> Substeps;
};
