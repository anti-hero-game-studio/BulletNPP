...
UBulletStaticMeshComponent::UBulletStaticMeshComponent(const FObjectInitializer& ObjectInitializer)
...
void UBulletStaticMeshComponent::InitializeComponent()
{
...
void UBulletStaticMeshComponent::SetSimulatePhysics(const bool bSimulate)
{
...
bool UBulletStaticMeshComponent::IsSimulatingPhysics(const FName BoneName) const
{
...
bool UBulletStaticMeshComponent::IsAnySimulatingPhysics() const
{
	return Super::IsAnySimulatingPhysics();
}

bool UBulletStaticMeshComponent::IsAnyRigidBodyAwake()
{
...
ECollisionResponse UBulletStaticMeshComponent::GetCollisionResponseToChannel(ECollisionChannel Channel) const
{
	const UBulletPhysicsWorldSubsystem* Subsystem = GetWorld()->GetSubsystem<UBulletPhysicsWorldSubsystem>();
...
const FCollisionResponseContainer& UBulletStaticMeshComponent::GetCollisionResponseToChannels() const
{
	const UBulletPhysicsWorldSubsystem* Subsystem = GetWorld()->GetSubsystem<UBulletPhysicsWorldSubsystem>();
