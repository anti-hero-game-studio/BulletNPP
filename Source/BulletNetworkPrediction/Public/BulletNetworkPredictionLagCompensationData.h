...
#include "BulletNetworkPredictionLagCompensationData.generated.h"
...
struct BULLETNETWORKPREDICTION_API FNpLagCompensationData
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct BULLETNETWORKPREDICTION_API FNpLagCompensationHistory
{
	GENERATED_BODY()
