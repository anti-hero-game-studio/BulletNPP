...
class FBulletNetworkPredictionModelDefRegistry
{
public:

	BULLETNETWORKPREDICTION_API static FBulletNetworkPredictionModelDefRegistry& Get()
	{
		static FBulletNetworkPredictionModelDefRegistry Instance;
		return Instance;
	}
...
private:
	...
	BULLETNETWORKPREDICTION_API static FBulletNetworkPredictionModelDefRegistry Singleton;
...
template<typename ModelDef>
struct TBulletNetworkPredictionModelDefRegisterHelper
{
	TBulletNetworkPredictionModelDefRegisterHelper()
	{
		FBulletNetworkPredictionModelDefRegistry::Get().RegisterType<ModelDef>();
	}
};
