...
#include "BulletNetworkPredictionLagCompensation.generated.h"
...
class BULLETNETWORKPREDICTION_API UBulletNetworkPredictionLagCompensation : public UActorComponent
{
	GENERATED_BODY()
	friend class UBulletNetworkPredictionWorldManager;
public:
	// Sets default values for this component's properties
	UBulletNetworkPredictionLagCompensation();

	UPROPERTY(EditAnywhere, BlueprintReadWrite,NoClear, Category = Settings,meta=(MetaStruct="/Script/BulletNetworkPrediction.NpLagCompensationData"))
