...
#include "BulletNetworkPredictionSettings.generated.h"
...
struct FBulletNetworkPredictionSettings
{
	...
	EBulletNetworkPredictionTickingPolicy PreferredTickingPolicy = EBulletNetworkPredictionTickingPolicy::Fixed;

	// Replicated Manager class
	UPROPERTY(config, EditAnywhere, Category = Global)
	TSubclassOf<ABulletNetworkPredictionReplicatedManager> ReplicatedManagerClassOverride;
	...
	UPROPERTY(config, EditAnywhere, Category = FixedTick)
	EBulletNetworkLOD SimulatedProxyNetworkLOD = EBulletNetworkLOD::Interpolated;
...
USTRUCT(meta=(ShowOnlyInnerProperties))
struct FBulletNetworkPredictionDevHUDItem
{
	GENERATED_BODY();
...
USTRUCT(meta=(ShowOnlyInnerProperties))
struct FBulletNetworkPredictionDevHUD
{
	GENERATED_BODY()
	...
	TArray<FBulletNetworkPredictionDevHUDItem> Items;
