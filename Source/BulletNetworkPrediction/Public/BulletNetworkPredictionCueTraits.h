...
// ----------------------------------------------------------------------------------------------------------------------------------------------
//	BulletNetSimCue Traits: compile time settings for BulletNetSimeCue types that determine who can invoke the event and who it replicates to.
...
//	static constexpr EBulletNetSimCueInvoker InvokeMask { InInvokeMask };
//
...
//	static constexpr EBulletNetSimCueReplicationTarget ReplicationTarget { InReplicationTarget };
//
// ----------------------------------------------------------------------------------------------------------------------------------------------

// When we run a SimulationTick, it will be done under one of these contexts. This isn't BulletNetSimCue specific and probably makes sense to move to the BulletNetSimModel types
enum class EBulletSimulationTickContext : uint8
{
	None				= 0,
...
ENUM_CLASS_FLAGS(EBulletSimulationTickContext);
...
enum class EBulletNetSimCueInvoker : uint8
{
	Authority			= (uint8)EBulletSimulationTickContext::Authority,
	Predict				= (uint8)EBulletSimulationTickContext::Predict,
	SimExtrapolate		= (uint8)EBulletSimulationTickContext::SimExtrapolate,

	All					= Authority | Predict | SimExtrapolate
};
ENUM_CLASS_FLAGS(EBulletNetSimCueInvoker);

// Turns "Who can invoke this" + "Does this play during resimulate" into the final EBulletSimulationTickContext mask we use at runtime. This is done so users can't make invalid configurations (like "Authority | Resimulate")
static constexpr EBulletSimulationTickContext GetSimTickMask(const EBulletNetSimCueInvoker Invoker, const bool bAllowResimulate)
{
	EBulletSimulationTickContext Mask = (EBulletSimulationTickContext)Invoker;
	EBulletSimulationTickContext AutoMask = (bAllowResimulate && EnumHasAllFlags(Invoker, EBulletNetSimCueInvoker::Predict)) ? EBulletSimulationTickContext::Resimulate : EBulletSimulationTickContext::None;
	EBulletSimulationTickContext SimMask = (bAllowResimulate && EnumHasAllFlags(Invoker, EBulletNetSimCueInvoker::SimExtrapolate)) ? EBulletSimulationTickContext::ResimExtrapolate : EBulletSimulationTickContext::None;
	return Mask | AutoMask | SimMask;
}

// Who a BulletNetSimCue should replicate/be accepted by
enum class EBulletNetSimCueReplicationTarget : uint8
{
...
ENUM_CLASS_FLAGS(EBulletNetSimCueReplicationTarget);

// ----------------------------------------------------------------------------------------------------------------------------------------------
//	BulletNetSimCue Traits Presets. These are reasonable settings that may be appropriate in common cases. Presets are provided so that individual settings
...
//		BulletNetSimCueTraits::Weak - The default trait type and cheapest cue to use. No replication or NetIdentical testing. Never rolled back. Predicted but never resimulated.
//		BulletNetSimCueTraits::Strong - The most robust trait type. Will replicate to everyone and will rollback/resimulate. Must implement NetSerialize/NetIdentical. Most expensive.
//
...
namespace BulletNetSimCueTraits
{
	...
	struct Weak
	{
		static constexpr EBulletNetSimCueInvoker InvokeMask { EBulletNetSimCueInvoker::All };
		static constexpr bool Resimulate { false };
		static constexpr EBulletNetSimCueReplicationTarget ReplicationTarget { EBulletNetSimCueReplicationTarget::None };
	};
	...
	{
		static constexpr EBulletNetSimCueInvoker InvokeMask { EBulletNetSimCueInvoker::Predict };
		static constexpr bool Resimulate { false };
		static constexpr EBulletNetSimCueReplicationTarget ReplicationTarget { EBulletNetSimCueReplicationTarget::None };
	};
	...
	{
		static constexpr EBulletNetSimCueInvoker InvokeMask { EBulletNetSimCueInvoker::Predict | EBulletNetSimCueInvoker::SimExtrapolate };
		static constexpr bool Resimulate { false };
		static constexpr EBulletNetSimCueReplicationTarget ReplicationTarget { EBulletNetSimCueReplicationTarget::None };
	};
	...
	{
		static constexpr EBulletNetSimCueInvoker InvokeMask { EBulletNetSimCueInvoker::Authority };
		static constexpr bool Resimulate { false };
		static constexpr EBulletNetSimCueReplicationTarget ReplicationTarget { EBulletNetSimCueReplicationTarget::None };
	};
	...
	struct ReplicatedNonPredicted
	{
		static constexpr EBulletNetSimCueInvoker InvokeMask { EBulletNetSimCueInvoker::Authority };
		static constexpr bool Resimulate { false };
		static constexpr EBulletNetSimCueReplicationTarget ReplicationTarget { EBulletNetSimCueReplicationTarget::All };
	};
	...
	struct ReplicatedXOrPredicted
	{
		static constexpr EBulletNetSimCueInvoker InvokeMask { EBulletNetSimCueInvoker::All };
		static constexpr bool Resimulate { false };
		static constexpr EBulletNetSimCueReplicationTarget ReplicationTarget { EBulletNetSimCueReplicationTarget::Interpolators };
	};
...
template<EBulletNetSimCueInvoker InInvokeMask, EBulletNetSimCueReplicationTarget InReplicationTarget, bool InResimulate>
struct TBulletNetSimCueTraitsExplicit
{
	// Who can Invoke this Cue in their simulation (if this test fails, the Invoke call is suppressed locally)
	static constexpr EBulletNetSimCueInvoker InvokeMask { InInvokeMask };
...
// ----------------------------------------------------------------------------------------------------------------------------------------------
//	BulletNetSimCue Traits template helpers
// ----------------------------------------------------------------------------------------------------------------------------------------------

// SFINAE helper
template<typename T>
struct TBulletToVoid
{
	using type  = void;
};
...
struct THasBulletNetSimCueTraits
{
	enum { Value = false };
};

template<typename T>
struct THasBulletNetSimCueTraits<T, typename TBulletToVoid<typename T::Traits>::type>
{
	enum { Value = true };
};

// Selects explicit traits set by T
template<typename T, bool HasTraits = THasBulletNetSimCueTraits<T>::Value>
struct TSelectBulletNetSimCueTraits
{
...
template<typename T>
struct TSelectBulletNetSimCueTraits<T, false>
{
	using Traits = BulletNetSimCueTraits::Default;
};

// Actual trait struct that we use to look up traits. The ways this can be set:
//	1. Explicitly specialize TBulletNetSimCueTraits for your type (non intrusive, but does not inherit)
//	2. Explicitly set Traits inside your struct. E.g:
//			using Traits = TBulletNetSimCueTraits_Strong; (intrustive but more concise, does support inherited types)
//	3. Automatically falls back to BulletNetSimCueTraits::Default if not explicitly set above
template<typename TCue>
struct TBulletNetSimCueTraits
{
	using Traits = typename TSelectBulletNetSimCueTraits<TCue>::Traits;

	static constexpr EBulletNetSimCueInvoker InvokeMask { Traits::InvokeMask };
	static constexpr bool Resimulate { Traits::Resimulate };
	static constexpr EBulletNetSimCueReplicationTarget ReplicationTarget { Traits::ReplicationTarget };
	static constexpr EBulletSimulationTickContext SimTickMask() { return GetSimTickMask((EBulletNetSimCueInvoker)InvokeMask, Resimulate); };
};
...
template <typename TCue>
struct TBulletNetSimCueTypeRequirements
{
	enum
	{
		// NetSerialize is required if we ever need to replicate
		RequiresNetSerialize = (TBulletNetSimCueTraits<TCue>::ReplicationTarget != EBulletNetSimCueReplicationTarget::None),
		...
		RequiresNetIdentical = (TBulletNetSimCueTraits<TCue>::ReplicationTarget != EBulletNetSimCueReplicationTarget::None) || (TBulletNetSimCueTraits<TCue>::Resimulate)
	};
};
...
template<typename TCue>
struct TBulletHasNetIdenticalHelper
{
...
template<typename TCue, bool Enabled=TBulletHasNetIdenticalHelper<TCue>::Value>
struct TBulletNetCueNetIdenticalHelper
{
...
template<typename TCue>
struct TBulletNetCueNetIdenticalHelper<TCue, true>
{
...
struct TBulletNetCueNetSerializeHelper
{
...
template<typename TCue>
struct TBulletNetCueNetSerializeHelper<TCue, true>
{
