...
#include "BulletMoverBlackboard.generated.h"

#define UE_API BULLETMOVER_API



enum class EBulletInvalidationReason : uint8
{
...
class UBulletMoverBlackboard : public UObject
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	UE_API void Invalidate(EBulletInvalidationReason Reason);
	
	/** Invalidate all objects */
	void InvalidateAll() { Invalidate(EBulletInvalidationReason::FullReset); }
