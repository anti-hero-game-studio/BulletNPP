...
#include "BulletMoverBackendLiaison.generated.h"
...
class UBulletMoverBackendLiaisonInterface : public UInterface
{
	GENERATED_BODY()
};

class IBulletMoverBackendLiaisonInterface
{
	GENERATED_BODY()
...
public:
	...
	virtual bool ReadPendingSyncState(OUT FBulletMoverSyncState& OutSyncState) { return false; }
	virtual bool WritePendingSyncState(const FBulletMoverSyncState& SyncStateToWrite) { return false; }
	...
	virtual bool ReadPresentationSyncState(OUT FBulletMoverSyncState& OutSyncState) { return false; }
	virtual bool WritePresentationSyncState(const FBulletMoverSyncState& SyncStateToWrite) { return false; }
	...
	virtual bool ReadPrevPresentationSyncState(OUT FBulletMoverSyncState& OutSyncState) { return false; }
	virtual bool WritePrevPresentationSyncState(const FBulletMoverSyncState& SyncStateToWrite) { return false; }

#if WITH_EDITOR
	virtual EDataValidationResult ValidateData(FDataValidationContext& Context, const UBulletMoverComponent& ValidationMoverComp) const { return EDataValidationResult::Valid; }
#endif // WITH_EDITOR
