...
#include "BulletMontageStateProvider.generated.h"
...
struct FBulletMoverAnimMontageState
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FBulletLayeredMove_MontageStateProvider : public FBulletLayeredMoveBase
{
	GENERATED_BODY()

	virtual FBulletMoverAnimMontageState GetMontageState() const
	{
		checkNoEntry();
		return FBulletMoverAnimMontageState();
	}
};
