...
#include "BulletBasicLayeredMoves.generated.h"
...
UENUM(BlueprintType)
enum class EBulletLayeredMove_ConstantVelocitySettingsFlags : uint8
{
	NoFlags						= 0,
...
struct FBulletLayeredMove_LinearVelocity : public FBulletLayeredMoveBase
{
	GENERATED_BODY()

	UE_API FBulletLayeredMove_LinearVelocity();

	virtual ~FBulletLayeredMove_LinearVelocity() {}
	...
	// @see EBulletLayeredMove_ConstantVelocitySettingsFlags
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Mover)
	uint8 SettingsFlags;
...
template<>
struct TStructOpsTypeTraits< FBulletLayeredMove_LinearVelocity > : public TStructOpsTypeTraitsBase2< FBulletLayeredMove_LinearVelocity >
{
	enum
	{
...
/** Jump Impulse Over Duration: introduces an instantaneous upwards change in velocity over a duration(ms).
  ...
  */
USTRUCT(BlueprintType)
struct FBulletLayeredMove_JumpImpulseOverDuration : public FBulletLayeredMoveBase
{
	GENERATED_BODY()

	UE_API FBulletLayeredMove_JumpImpulseOverDuration();

	virtual ~FBulletLayeredMove_JumpImpulseOverDuration() {}
...
template<>
struct TStructOpsTypeTraits< FBulletLayeredMove_JumpImpulseOverDuration > : public TStructOpsTypeTraitsBase2< FBulletLayeredMove_JumpImpulseOverDuration >
{
	enum
	{
		//WithNetSerializer = true,
...
/** JumpTo: Moves this actor in a more jump-like manner - specifying height and distance of jump rather than just upwards speed
  ...
  */
USTRUCT(BlueprintType)
struct FBulletLayeredMove_JumpTo : public FBulletLayeredMoveBase
{
	GENERATED_BODY()

	UE_API FBulletLayeredMove_JumpTo();
	virtual ~FBulletLayeredMove_JumpTo() {}
...
template<>
struct TStructOpsTypeTraits< FBulletLayeredMove_JumpTo > : public TStructOpsTypeTraitsBase2< FBulletLayeredMove_JumpTo >
{
	enum
	{
		//WithNetSerializer = true,
...
USTRUCT(BlueprintType)
struct FBulletLayeredMove_MoveTo : public FBulletLayeredMoveBase
{
	GENERATED_BODY()

	UE_API FBulletLayeredMove_MoveTo();
	virtual ~FBulletLayeredMove_MoveTo() {}
...
template<>
struct TStructOpsTypeTraits< FBulletLayeredMove_MoveTo > : public TStructOpsTypeTraitsBase2< FBulletLayeredMove_MoveTo >
{
	enum
	{
		//WithNetSerializer = true,
 ...
 */
USTRUCT(BlueprintType)
struct FBulletLayeredMove_MoveToDynamic : public FBulletLayeredMove_MoveTo
{
	GENERATED_BODY()

	UE_API FBulletLayeredMove_MoveToDynamic();
	virtual ~FBulletLayeredMove_MoveToDynamic() {}
...
template<>
struct TStructOpsTypeTraits< FBulletLayeredMove_MoveToDynamic > : public TStructOpsTypeTraitsBase2< FBulletLayeredMove_MoveToDynamic >
{
	enum
	{
		//WithNetSerializer = true,
...
USTRUCT(BlueprintType)
struct FBulletLayeredMove_RadialImpulse : public FBulletLayeredMoveBase
{
	GENERATED_BODY()

	UE_API FBulletLayeredMove_RadialImpulse();
	virtual ~FBulletLayeredMove_RadialImpulse() {}
...
template<>
struct TStructOpsTypeTraits< FBulletLayeredMove_RadialImpulse > : public TStructOpsTypeTraitsBase2< FBulletLayeredMove_RadialImpulse >
{
	enum
	{
		//WithNetSerializer = true,
