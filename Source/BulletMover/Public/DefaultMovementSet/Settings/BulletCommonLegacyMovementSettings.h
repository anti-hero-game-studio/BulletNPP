...
#include "BulletCommonLegacyMovementSettings.generated.h"
...
class UBulletCommonLegacyMovementSettings : public UObject, public IBulletMovementSettingsInterface
{
	GENERATED_BODY()
