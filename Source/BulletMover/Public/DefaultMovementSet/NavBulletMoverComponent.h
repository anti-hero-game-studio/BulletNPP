...
#include "NavBulletMoverComponent.generated.h"

#define UE_API BULLETMOVER_API

/**
 * NavMoverComponent: Responsible for implementing INavMoveInterface with UBulletMoverComponent so pathfinding and other forms of navigation movement work.
...
class UNavBulletMoverComponent : public UActorComponent, public INavMovementInterface
{
	GENERATED_BODY()

public:
	UE_API UNavBulletMoverComponent();
