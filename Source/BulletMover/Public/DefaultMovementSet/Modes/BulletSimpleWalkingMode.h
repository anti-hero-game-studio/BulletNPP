...
public:
	...
	UE_API void GenerateWalkMove(UPARAM(ref) FBulletMoverTickStartData& StartState, float DeltaSeconds, const FVector& DesiredVelocity,
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bullet Mover|Walking Settings", meta = (ForceUnits = "cm/s"))
