...
class UNavBulletMoverComponent;
...
UENUM(BlueprintType)
enum class EBulletOffNavMeshBehavior : uint8
{
...
public:
	...
	UPROPERTY(Category = "NavMesh Movement", EditAnywhere, BlueprintReadWrite)
	EBulletOffNavMeshBehavior BehaviorOffNavMesh = EBulletOffNavMeshBehavior::SwitchToWalking;
...
protected:
	...
	TObjectPtr<UNavBulletMoverComponent> NavMoverComponent;
	...
	UE_API void CaptureFinalState(USceneComponent* UpdatedComponent, const FBulletMovementRecord& Record, const FVector& AngularVelocityDegrees, FBulletMoverDefaultSyncState& OutputSyncState) const;
