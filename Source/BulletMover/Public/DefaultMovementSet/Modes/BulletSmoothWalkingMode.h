...
class UBulletSmoothWalkingMode : public UBulletSimpleWalkingMode
{
	GENERATED_BODY()
...
protected: // Velocity Controls
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bullet Mover|Smooth Walking Settings", meta = (ClampMin = "0", UIMin = "0", ForceUnits = "cm/s^2"))
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bullet Mover|Advanced Smooth Walking Settings", meta = (ClampMin = "0", UIMin = "0", ClampMax = "1", UIMax = "1"))
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bullet Mover|Smooth Walking Settings", meta = (ClampMin = "0", UIMin = "0"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bullet Mover|Smooth Walking Settings", meta = (ClampMin = "0", UIMin = "0", ForceUnits = "s"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bullet Mover|Advanced Smooth Walking Settings", meta = (ClampMin = "0", UIMin = "0", ForceUnits = "cm/s"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bullet Mover|Advanced Smooth Walking Settings", meta = (ClampMin = "0", UIMin = "0", ForceUnits = "cm/s^2"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bullet Mover|Advanced Smooth Walking Settings", meta = (ClampMin = "0", UIMin = "0", ForceUnits = "s"))
...
protected: // Facing Controls
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bullet Mover|Advanced Smooth Walking Settings")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bullet Mover|Advanced Smooth Walking Settings", meta = (ClampMin = "0", UIMin = "0", ForceUnits = "deg"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bullet Mover|Advanced Smooth Walking Settings", meta = (ClampMin = "0", UIMin = "0", ForceUnits = "deg/s"))
