...
class UBulletAsyncNavWalkingMode : public UBulletBaseMovementMode
{
	GENERATED_BODY()

public:
	UE_API UBulletAsyncNavWalkingMode();
...
protected:
	...
	TWeakObjectPtr<UNavBulletMoverComponent> NavMoverComponent;
