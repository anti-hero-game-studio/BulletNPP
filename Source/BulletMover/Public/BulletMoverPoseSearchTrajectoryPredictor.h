...
#include "BulletMoverPoseSearchTrajectoryPredictor.generated.h"
...
class UBulletMoverTrajectoryPredictor : public UObject, public IPoseSearchTrajectoryPredictorInterface
{
	GENERATED_BODY()
...
public:
	...
	void Setup(UBulletMoverComponent* InMoverComponent) { MoverComponent = InMoverComponent; }
	...
	static UE_API void Predict(UBulletMoverComponent& Mover, FTransformTrajectory& InOutTrajectory, int32 NumPredictionSamples, float SecondsPerPredictionSample, int32 NumHistorySamples, float MoverSamplingInterval);
	static UE_API void GetCurrentState(UBulletMoverComponent& Mover, FVector& OutPosition, FQuat& OutFacing, FVector& OutVelocity);


protected:
	TObjectPtr<UBulletMoverComponent> MoverComponent;
