...
#include "DefaultMovementSet/Modes/BulletSmoothWalkingMode.h"
#include "DefaultMovementSet/Modes/BulletSmoothWalkingState.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(BulletSmoothWalkingMode)

void UBulletSmoothWalkingMode::SimulationTick_Implementation(const FBulletSimulationTickParams& Params, FBulletMoverTickEndData& OutputState)
{
...
void UBulletSmoothWalkingMode::GenerateWalkMove_Implementation(FBulletMoverTickStartData& StartState, float DeltaSeconds, const FVector& DesiredVelocity,
