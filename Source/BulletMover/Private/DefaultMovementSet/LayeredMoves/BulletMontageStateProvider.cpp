...
#include UE_INLINE_GENERATED_CPP_BY_NAME(BulletMontageStateProvider)


void FBulletMoverAnimMontageState::Reset()
{
	Montage = nullptr;
}

void FBulletMoverAnimMontageState::NetSerialize(FArchive& Ar)
{
	Ar << Montage;
