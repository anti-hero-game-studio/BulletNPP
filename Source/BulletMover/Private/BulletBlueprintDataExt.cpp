...
#include "BulletBlueprintDataExt.h"
#include "BulletMoverLog.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(BulletBlueprintDataExt)


static constexpr uint8 NumValueMaps = 6;


bool FBulletMoverDictionaryData::NetSerialize(FArchive& Ar, UPackageMap* Map, bool& bOutSuccess)
{
...
void FBulletMoverDictionaryData::ToString(FAnsiStringBuilderBase& Out) const
{
	Super::ToString(Out);
...
void FBulletMoverDictionaryData::Interpolate(const FBulletMoverDataStructBase& From, const FBulletMoverDataStructBase& To, float Alpha)
{
	const FBulletMoverDictionaryData& FromTyped = *static_cast<const FBulletMoverDictionaryData*>(&From);
	const FBulletMoverDictionaryData& ToTyped = *static_cast<const FBulletMoverDictionaryData*>(&To);

	const FBulletMoverDictionaryData& PrimaryInfluence   = Alpha < 0.5f ? FromTyped : ToTyped;
	const FBulletMoverDictionaryData& SecondaryInfluence = Alpha < 0.5f ? ToTyped : FromTyped;
...
void FBulletMoverDictionaryData::Merge(const FBulletMoverDataStructBase& From)
{
	const FBulletMoverDictionaryData& FromTyped = *static_cast<const FBulletMoverDictionaryData*>(&From);
...
bool FBulletMoverDictionaryData::ShouldReconcile(const FBulletMoverDataStructBase& AuthorityState) const
{
